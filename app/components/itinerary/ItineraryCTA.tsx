        ...
        <div className="row align-items-center">
          ...
          <div className="col-7 col-md-5 offset-md-1 itinerary-cta__text-col">
            <div className="itinerary-cta__text">
              <h2 className="itinerary-cta__title">Listen to your heart</h2>

              <div className="itinerary-cta__copy-svg">
                <Image
                  src="/assets/itinerary/itinerary-comp.svg"
                  alt="Each journey is crafted to express your higher purpose. You just have to answer the call"
                  width={600}
                  height={200}
                />
              </div>
