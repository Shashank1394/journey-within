						...
						<div className="connect w-100 d-flex flex-column justify-content-center text-center">
							...
							<div className="connect-svg">
								<Image
									...
									alt="And I'm looking forward to guiding you through our beautiful journey, both in India and within. I invite you to discover what pushed me to create this project"
									width={600}
									height={200}
								/>
							</div>
